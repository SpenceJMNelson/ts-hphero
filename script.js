...
let textparallax = gsap.utils.toArray(".hero-text .mouseparallax");
...
gsap.timeline({repeat: -1}).to(".imagelayerframe-1 .imagewrapper",{opacity:1, x:0, stagger:0.1, duration:.6, ease:Circ.easeInOut})
               .to(".imagelayerframe-1 .imagewrapper",{opacity:0, x:60, stagger:0.1, duration:.6, ease:Circ.easeInOut}, "+=3")
               .to(".imagelayerframe-2 .imagewrapper",{opacity:1, x:0, stagger:0.1, duration:.6, ease:Circ.easeInOut}, "-=.3")
               .to(".imagelayerframe-2 .imagewrapper",{opacity:0, x:60, stagger:0.1, duration:.6, ease:Circ.easeInOut}, "+=3")
               .to(".imagelayerframe-3 .imagewrapper",{opacity:1, x:0, stagger:0.1, duration:.6, ease:Circ.easeInOut}, "-=.3")
               .to(".imagelayerframe-3 .imagewrapper",{opacity:0, x:60, stagger:0.1, duration:.6, ease:Circ.easeInOut}, "+=3")
